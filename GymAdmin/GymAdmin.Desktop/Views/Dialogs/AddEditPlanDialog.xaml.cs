...
/// <summary>
/// Lógica de interacción para AddEditPlanDialog.xaml
/// </summary>
public partial class AddEditPlanDialog : UserControl
{
    public AddEditPlanDialog()
    {
        InitializeComponent();
        Loaded += OnLoaded;
    }
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        {
            NamePlanTextBox.Focus();
            NamePlanTextBox.CaretIndex = NamePlanTextBox.Text?.Length ?? 0;
            NamePlanTextBox.SelectAll();
        }));
    }
